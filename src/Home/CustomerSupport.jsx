...
const CustomerSupport = () => {
    return (
        <div className='max-w-7xl mx-auto flex items-center justify-between my-9'>
            <div>
                <h1 className='text-[48px] font-bold text-[#0F2137] leading-14'>Free Customer Support <br /> to ensure what you like <br /> to expect</h1>
